...
public class DoubleLikedList<T> {
    ...
    public boolean add(T item){
        ...
        newNode.prev = tempNode; // 将最后一个节点指向新添加节点的prev
        return true;
    }
    ...
    public boolean remove(T item) {
        ...
        while (true) {
            ...
            if (item.equals(tempNode.next.item)) {
                ...
                // 如果当前节点为最后一个节点，就无需执行下一个节点的前一个节点
                if(tempNode.next != null){
    ...
    public Node<T> reverseLinkList() {
        ...
        while (tempNode != null) {
            ...
            // 后面依次遍历
            currentNode.next = prev; // 当前节点的下一个节点
            currentNode.prev = next; // 当前节点的前一个节点
            // 将当前节点赋值给临时变量 -> 前一个节点
            prev = currentNode;
